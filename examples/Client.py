...
def main():
    ...
    parser.add_argument('--peers', type=str, help='Path to file contain peers (in the format ip:port for each line) or string in the same format but delimited by commas')
